...
module.exports = {
  link: [
    ...
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Lato|Open+Sans' },

    { rel: 'stylesheet', type: 'text/css', href: '/assets/css/site.css' },
    
    { rel: 'manifest', href: '/assets/manifest.json' },
  ],
  meta: [
    { name: 'msapplication-TileColor', content: '#380404' },
    { name: 'msapplication-TileImage', content: '/assets/icon/100x100.png', '=content': true },
    { name: 'theme-color', content: '#380404' }
  ]
};
